...
func RunningSpentCalories(action int, weight, duration float64) float64 {
	// ваш код здесь
	averageSpeedKmH := meanSpeed(action, duration)
	calories := ((runningCaloriesMeanSpeedMultiplier * averageSpeedKmH * runningCaloriesMeanSpeedShift) * weight / mInKm * duration * minInH)
	return calories
}
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	...
	calories := ((walkingCaloriesWeightMultiplier*weight + (math.Pow(averageSpeedMsec, 2)/(height/100))*walkingSpeedHeightMultiplier*weight) * duration * minInH)
	return calories
}
...
func SwimmingSpentCalories(lenghtPool, countPool int, duration, weight float64) float64 {
	// ваш код здесь
	averageSpeedKmH := swimmingMeanSpeed(lenghtPool, countPool, duration)
	calories := (averageSpeedKmH + swimmingCaloriesMeanSpeedShift) * swimmingCaloriesWeightMultiplier * weight * duration
	return calories
}
